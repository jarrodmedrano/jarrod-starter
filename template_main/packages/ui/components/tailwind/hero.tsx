        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href={buttonLink}
                className="bg-primary-500 hover:bg-primary-400 focus-visible:outline-primary-400 rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-2xs focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
              >
                {buttonText}
              </a>
              <a
