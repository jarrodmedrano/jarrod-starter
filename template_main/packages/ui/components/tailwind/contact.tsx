            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                <select
                  id="country"
                  name="country"
                  className="h-full rounded-md border-0 bg-transparent bg-none py-0 pr-9 pl-4 text-gray-400 focus:ring-2 focus:ring-indigo-600 focus:ring-inset sm:text-sm"
                >
                  <option>US</option>
                  <option>CA</option>
                  <option>EU</option>
            ...
            <div className="flex h-6 items-center">
              <Switch
                ...
                className={classNames(
                  ...
                  'focus-visible:outline-primary-600 flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-gray-900/5 transition-colors duration-200 ease-in-out ring-inset focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
                )}
              >
                ...
                <span
                  ...
                  className={classNames(
                    ...
                    'h-4 w-4 transform rounded-full bg-white shadow-2xs ring-1 ring-gray-900/5 transition duration-200 ease-in-out',
                  )}
                />
              </Switch>
            </div>
