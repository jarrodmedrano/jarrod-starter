...
interface Client {
  query: (_config: QueryArrayConfig) => Promise<QueryArrayResult>
}
...
export async function updateSessionExpiration(
  client: Client,
  args: UpdateSessionExpirationArgs,
): Promise<UpdateSessionExpirationRow | null> {
  const result = await client.query({
...
export async function createVerificationToken(
  client: Client,
  args: CreateVerificationTokenArgs,
): Promise<CreateVerificationTokenRow | null> {
  const result = await client.query({
...
export async function createTwoFactorToken(
  client: Client,
  args: CreateTwoFactorTokenArgs,
): Promise<CreateTwoFactorTokenRow | null> {
  const result = await client.query({
...
export async function getTwoFactorToken(
  client: Client,
  args: GetTwoFactorTokenArgs,
): Promise<GetTwoFactorTokenRow | null> {
  const result = await client.query({
...
export async function createTwoFactorConfirmation(
  client: Client,
  args: CreateTwoFactorConfirmationArgs,
): Promise<CreateTwoFactorConfirmationRow | null> {
  const result = await client.query({
...
export async function getTwoFactorConfirmation(
  client: Client,
  args: GetTwoFactorConfirmationArgs,
): Promise<GetTwoFactorConfirmationRow | null> {
  const result = await client.query({
...
export async function deleteTwoFactorConfirmation(
  client: Client,
  args: DeleteTwoFactorConfirmationArgs,
): Promise<void> {
  await client.query({
